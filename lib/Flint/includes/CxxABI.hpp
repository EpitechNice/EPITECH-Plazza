...
#ifndef INCLUDED_FLINT_CXXABI_HPP
    #define INCLUDED_FLINT_CXXABI_HPP
...
{
    /**
      * @brief Wrapper around usefull C++/C low level functions
      *
    ...
    class CxxABI
    {
        public:
            ...
            */
            ...
            /**
              * @brief Get functions infos from symbol extraction
              *
            ...
            */
            ...
            /**
              * @brief Retreive the execution trace
              *
