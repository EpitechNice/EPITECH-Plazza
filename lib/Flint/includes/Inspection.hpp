...
#ifndef INCLUDED_FLINT_INSPECTION_HPP
    #define INCLUDED_FLINT_INSPECTION_HPP
...
{
    /**
      * @brief Base class to implement simplet self-reflexion in C++
      *
    ...
    */
    ...
    class Inspection
    {
        public:
            /**
              * @brief Return the name of the reflected class
              *
            ...
            */
            ...
            /** @brief Overload the operator << to use the str method of the object
              *
